...
$pagetitle = "Edit External";
?><?php include('includes/header.php'); ?>
 <?php admin_logged_in(); 
 
$advert = get_external($_GET['extn']);
...
$db_images = "";
			...
			if (empty($errors)) {
				...
				redirect_to('manage_external.php');
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edit  External</h4>
               ...
               <!-- <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit  External</h4>
	...
	<?php if (!empty($message)) {
			...
			?>							
						...
						<form class="m-t-20" method="post" action="manage_editexternal.php?extn=<?php echo $_GET["extn"]; ?>" enctype="multipart/form-data">		
								  <input type="hidden" class="form-control"  value="<?php echo time(); ?>" name="time">
                                    ...
                                    <div class="">
										...
										<span>Name <em style="color:#FF0000;"><?php echo $advert_part['name']; ?></em></span>
                                            <input type="text" class="form-control" name="name" value="<?php echo $advert_part['name']; ?>" >
                                        </div>
