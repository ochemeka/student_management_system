...
<?php
$pagetitle="Manage tranx_activity";
?>
<?php include('includes/header.php'); ?>
 ...
 if (isset($_GET['approve'])) {
	// Success!
					$userid =  $_GET['approve'];
					$query0 = 	"UPDATE tranx_activity SET 
						tranx_status = 1  
						WHERE tranx_id  = '$userid'";
			$result0 = mysqli_query($connection,$query0);
			//$result0 = mysql_query($query0);
			if($result0)
			{ 

redirect_to("manage_tranx_activity.php?status=asuccess");
}
}
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage tranx_activity</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage tranx_activity</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage tranx_activity &nbsp;&nbsp;&nbsp;&nbsp; <a href="addtranx_activity.php"></a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>tranx_activity";
...
$results = $connection->query("SELECT COUNT(*) FROM tranx_activity "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM tranx_activity WHERE tranx_status !=7 ORDER BY tranx_id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['tranx_user']; ?></td>
                                                <td><?php echo $row['orderInvoice']; ?></td>
												<td><?php echo $row['tranx_type']; ?></td>
												<td><?php echo $row['tranx_amt']; ?></td>
												<td><?php echo $row['tranx_from']; ?></td>
                                                <td><?php echo $row['tranx_date']; ?></td>
                                                <td>(<?php if($row['tranx_status']==1){ ?><a href="manage_tranx_activity.php?disapprove=<?php echo $row['tranx_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_tranx_activity.php?approve=<?php echo $row['tranx_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_tranx_activity.php?delete=<?php echo $row['tranx_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_edittranx_activity.php?cat=<?php echo $row['tranx_id']; ?>">Edit</a>)</td>
