...
<?php
$pagetitle="Manage Vendor_review";
?>
<?php include('includes/header.php'); ?>
 ...
 if (isset($_GET['approve'])) {
	// Success!
					$userid =  $_GET['approve'];
					$query0 = 	"UPDATE vendor_review SET 
						r_status = 1  
						WHERE r_id  = '$userid'";
...
redirect_to("manage_vendor_review.php?status=asuccess");
}
}
...
if (isset($_GET['disapprove'])) {
	// Success!
					...
					$query1 = 	"UPDATE vendor_review SET 
						r_status = 0   
						WHERE r_id 	 = '$userid'";
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage vendor_review</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage vendor_review</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Category&nbsp;&nbsp;&nbsp;&nbsp; <a href="addvendor_review.php"></a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>vendor_review";
...
$results = $connection->query("SELECT COUNT(*) FROM vendor_review "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM vendor_review WHERE r_status !=7 ORDER BY r_id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
												...
												<td><?php echo $row['r_subject']; ?></td>
												<td><?php echo $row['r_comment']; ?></td>
                                                <td><?php echo $row['r_time']; ?></td>
                                                <td>(<?php if($row['r_status']==1){ ?><a href="manage_vendor_review.php?disapprove=<?php echo $row['r_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_vendor_review.php?approve=<?php echo $row['r_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_vendor_review.php?delete=<?php echo $row['r_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editvendor_review.php?rvw=<?php echo $row['r_id']; ?>">Edit</a>)</td>
