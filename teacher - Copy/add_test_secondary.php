...
<div class="card-body">
   <div class="form-group">
        ...
        <input name="title" type="text" value="" placeholder=" Enter Subject name" class="form-control" />
        ...
        <!-- <div class="form-group">
              ...
              <input name="subject" type="text" value="" placeholder=" Enter Subject Code eg MAT 101" class="form-control" />
                  ...
                  <label style="color:#000;"><span>Select Student </span></label>
              <select type="text" class="form-control"  placeholder="Enter Name" name="student">
                ...
                <div class="form-group">
                    ...
                    <label style="color:#000;"><span>Select Subject </span></label>
