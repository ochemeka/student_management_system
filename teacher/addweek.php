...
//$db_images = "";
			...
			$required_fields = array('tit','descr');
        ...
        //         $stu_class = stripslashes($_REQUEST['class']);
				...
				if ($result) {
				echo "<script type='text/javascript'>alert('Week added successfully !')</script>";
					redirect_to('manage_weeks.php');
...
<div class="card-body">
   <div class="form-group">
        ...
        <input name="descr" type="text" value="" placeholder=" Enter Subject name" class="form-control" required />
        ...
        <div class="form-group">
              ...
              <input name="mcode" type="text" value="" placeholder=" Enter Subject Code eg MAT 101" class="form-control" />
                  ...
                  <select type="text" class="form-control"  placeholder="Enter Name" name="class_id"> -->
                  <!-- <option value="0">Select your Class</option> -->
                  <?php  													
                    // $query = "SELECT * from class_tbl order by class_id";
                    // $result = mysqli_query($connection,$query);
                    // while($cat_set=mysqli_fetch_array($result)) {
                    // echo "<option value=$cat_set[class_id]>$cat_set[class_title]</option>";
                    // }
                    // ?>
                  <!-- </select> -->
                ...
                <div class="form-group">
                    ...
                    <label style="color:#000;"><span>Select Week </span></label>
                        <select type="text" class="form-control"  placeholder="Select Subject Type" name="tit" required >
