        ...
        <div class="container">
            <div class="row">
                    ...
                    <div class="news-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            ...
                            <div class="lower-content">
                                ...
                                <div class="link-btn"><a href="blog-details.php"><i class="flaticon-next"></i></a></div>
                                <div class="more-btn"><a href="blog-details.php" class="theme-btn">Read More</a></div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.php"><img src="images/resource/news-5.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <h3><a href="blog-details.php">How to Create a Learning Environment</a></h3>
                                <ul class="info-box">
                                    <li>23 July, 2019</li>
                                    <li>5 Comments</li>
                                </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.php"><img src="images/resource/news-6.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <h3><a href="blog-details.php">Full Day Session with New Activities</a></h3>
                                <ul class="info-box">
                                    <li>22 July, 2019</li>
                                    <li>7 Comments</li>
                                </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.php"><img src="images/resource/news-7.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <h3><a href="blog-details.php">10 Skills Which Kids Will Learn</a></h3>
                                <ul class="info-box">
                                    <li>21 July, 2019</li>
                                    <li>4 Comments</li>
                                </ul>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="00ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.php"><img src="images/resource/news-8.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <h3><a href="blog-details.php">The Indoor Activities for Everyone</a></h3>
                                <ul class="info-box">
                                    <li>20 July, 2019</li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.php"><img src="images/resource/news-9.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <h3><a href="blog-details.php">We Make Difference in the Life Child</a></h3>
                                <ul class="info-box">
                                    <li>19 July, 2019</li>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 news-block">
                    <div class="news-block-one wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <div class="inner-box">
                            <figure class="image-box"><a href="blog-details.php"><img src="images/resource/news-10.jpg" alt=""></a></figure>
                            <div class="lower-content">
                                <h3><a href="blog-details.php">Kids Grooming with New Lessons</a></h3>
                                <ul class="info-box">
                                    <li>18 July, 2019</li>
