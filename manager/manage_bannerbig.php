...
redirect_to("manage_advert.php?status=asuccess");
}
}
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Advert</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Advert</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Advert</h4>
...
<?php } } ?>
                                               ...
                                               <td><?php echo $row['a_time']; ?></td>
                                                <td>(<?php if($row['a_status']==1){ ?><a href="manage_advert.php?disapprove=<?php echo $row['a_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_advert.php?approve=<?php echo $row['a_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_advert.php?delete=<?php echo $row['a_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editadvert.php?pid=<?php echo $row['a_id']; ?>">Edit</a>)</td>
