...
redirect_to("manage_track.php?status=asuccess");
}
}
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                               <h4 class="card-title">Manage slider &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="addtrack.php">Add Track</a></h4>
...
$results = $connection->query("SELECT * FROM tracktbl WHERE status !=7 ORDER BY id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['cur_loc']; ?></td>
												<td><?php echo $row['cur_date']; ?></td>
                                               <td><?php echo $row['time']; ?><?php //echo timeAgo1(get_date_2a($row['time']));?></td>
											   <td><?php echo $row['description']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_track.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_track.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_track.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_edittrack.php?track=<?php echo $row['id']; ?>">Edit</a>)</td>
