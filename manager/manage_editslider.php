...
?>
	...
	<?php if (!empty($message)) {
			...
			?>							
						...
						<form class="m-t-20" method="post" action="manage_editslider.php?slide=<?php echo $_GET["slide"]; ?>" enctype="multipart/form-data">		
								  <input type="hidden" class="form-control"  value="<?php echo time(); ?>" name="time">
								 
                                    <div class="">
                                        <div class="form-group">
										<span>Name <em style="color:#FF0000;"><?php echo $advert_part['s_title']; ?></em></span>
                                            <input type="text" class="form-control" name="name" value="<?php echo $advert_part['s_title']; ?>" name="memcode" placeholder="">
                                        </div>
										
										 <div class="form-group">
										<!--<span>First Name <em style="color:#FF0000;"><?php //echo $advert_part['cat_image']; ?></em></span>-->
										<?php 
														$img_url = $advert_part["slider_image"];
...
<img src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $cat_part['slider_image']; ?>" height="100" width="100" />
<?php } } ?>   
                                        ...
                                        <div class="form-group">
									<span>Image Size <em style="color:#FF0000;">570 x 361px</em></span>
