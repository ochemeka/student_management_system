    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <?php 
                            ...
                            <img class="img-circle elevation-2" src="<?php echo IMAGE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $stud_part['img_alt']; ?>" height="100" width="200" />
                            <?php } } ?>   
         ...
         <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
             ...
             <li class="nav-item">
                <a href="check_test.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Test Scores</p>
                </a>
              </li>
