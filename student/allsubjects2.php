...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>  
                  <tr>
                      ...
                      <td><button oncontextmenu="return false" type="button" class="btn btn-success toastrDefaultSuccess"><a href="manage_editsubject.php?sub=<?php echo $row['sub_id']; ?>"><i  style="color:#FFF;" >Edit Subject</i></a></button></td>
                   
                      <?php //echo $row['status']; ?>   <!-- <?php //if($row['status']==1){ ?>
