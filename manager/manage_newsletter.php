...
redirect_to("manage_newsletter.php?status=asuccess");
}
}
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage newsletter&nbsp;&nbsp;&nbsp;&nbsp; <a href="addnewsletter.php">Add newsletter</a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>newsletter";
...
$results = $connection->query("SELECT COUNT(*) FROM newsletter "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM newsletter WHERE status !=7 ORDER BY id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
                                                ...
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_newsletter.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_newsletter.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_newsletter.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editnewsletter.php?nws=<?php echo $row['id']; ?>">Edit</a>)</td>
