...
redirect_to("manage_plans.php?status=asuccess");
}
}
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Plans &nbsp;&nbsp;&nbsp;&nbsp; <a href="addplans.php"></a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>plans";
...
$results = $connection->query("SELECT COUNT(*) FROM plans "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM plans  ORDER BY id ASC LIMIT $page_position, $item_per_page");
	 ...
	 ?>								
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['planname']; ?></td>
                                                 <td><?php echo $row['planamt']; ?></td>
                                               <td><?php echo $row['planpayout']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_plans.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_plans.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_plans.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editplans.php?cat=<?php echo $row['id']; ?>">Edit</a>)</td>
