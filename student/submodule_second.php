...
?>                       
                           ...
                           <a href="submodule.php?sub=<?php echo $row['sub_name']; ?> "> <span  style="color:#FFF;"> View</span></a>
                            </button> 
...
$tm = 'Second-Term';
//Fetch a group of records using SQL LIMIT clause
$results = $connection->query("SELECT * FROM school_syllabus  WHERE  term = '$tm'  AND status != 7  ORDER BY id ASC LIMIT $page_position, $item_per_page");
