...
redirect_to("manage_ewallet.php?status=asuccess");
}
}
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage ewallet&nbsp;&nbsp;&nbsp;&nbsp; <a href="addewallet.php">Add ewallet</a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>ewallet";
...
$results = $connection->query("SELECT COUNT(*) FROM ewallet "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM ewallet WHERE wal_id !=7 ORDER BY user_id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['eballance']; ?></td>
                                                
                                               <td><?php echo $row['username']; ?></td>
                                                <td>(<?php if($row['wal_id']==1){ ?><a href="manage_ewallet.php?disapprove=<?php echo $row['user_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_ewallet.php?approve=<?php echo $row['user_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_ewallet.php?delete=<?php echo $row['user_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editewallet.php?wall=<?php echo $row['user_id']; ?>">Edit</a>)</td>
