...
//                $content = mysql_prep($_POST['content']); 
				...
				$query = 	"UPDATE teacher_tbl SET 
						 img_alt  = '{$title }',
						 image = '{$passport}' 
						WHERE t_id = '{$_SESSION['t_username']}'
						";	
...
<div class="card-body">
   <div class="form-group">
        ...
        <input type="text" value="<?php echo $teachpart['img_alt'];?>" class="form-control" id="field-1" name="title">
    </div>
</div>
                <div class="card-body">
              <div class="form-group">
         ...
         <?php 
                            ...
                            <?php  if(strlen($img_url1)>4){  ?>
                              <a download href="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>"><img download  src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $teachpart['img_alt']; ?>" height="100" width="100" /></a>
