...
$db_images = "";
			...
			if (empty($errors)) {
				...
				//$stid = mysql_prep($_GET['pid']);
					...
					/*"
					*/
				$query = "INSERT INTO advertsright (
						 	r_name, r_image, description
						) VALUES (
							'{$title}','{$passport}', '{$desc}')";
         
				$result = mysqli_query($connection,$query);
				if ($result) {
				echo "<script type='text/javascript'>alert('Right Banner created successfully !')</script>";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Add Right Advert</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Right Advert</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add Right Advert</h4>
