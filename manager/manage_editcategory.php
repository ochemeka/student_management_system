               ...
               <!-- <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
						...
						<form class="m-t-20" method="post" action="manage_editcategory.php?cat=<?php echo $_GET["cat"]; ?>" enctype="multipart/form-data">		
			...
			?>	
								 ...
								 <!-- <input type="hidden" class="form-control"  value="<?php //echo time(); ?>" name="time">-->
                                    ...
                                    <div class="">
										...
										<span>Name <em style="color:#FF0000;"><?php echo $cat_part['cat_name']; ?></em></span>
                                            <input type="text" class="form-control" name="name" value="<?php echo $cat_part['cat_name']; ?>" name="memcode" placeholder="Memcode">
                                        </div>
										
										 <div class="form-group">
										<!--<span>First Name <em style="color:#FF0000;"><?php //echo $cat_part['cat_image']; ?></em></span>-->
										<?php 
...
<img src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $cat_part['cat_image']; ?>" height="100" width="100" />
<?php } } ?>   
										
										
                                            <!--<input type="text" class="form-control" name="firstname" value="<?php e//cho $cat_part['firstname']; ?>" name="firstname" placeholder="First Name">-->
                                        </div>
							...
							<input name="file_go" type="hidden" id="file_go" value="go" />
										...
										<div class="form-group">
										<span>description <em style="color:#FF0000;"><?php echo $cat_part['cat_slug']; ?></em></span>
                                            <input type="text" class="form-control" name="desc" value="<?php echo $cat_part['cat_slug']; ?>" placeholder="Email">
                                        </div>
