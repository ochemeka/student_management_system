...
//<!--	time,pr_category,pr_subcat,pr_subchildcat,productcode,new_price,old_price,name,	description,colors,pr_owner,		-->
				...
				$query = "INSERT INTO products (
						pr_category, pr_subcat, pr_subchildcat, productcode, new_price, old_price, name, description, pr_img, colors, pr_owner, time
						) VALUES (
							'{$pr_category}', '{$pr_subcat}', '{$pr_subchildcat}', '{$productcode}', '{$new_price}', '{$old_price}', '{$name}', '{$description}', '{$passport}', '{$colors}', '{$pr_owner}', '{$time}')";
         
				$result = mysqli_query($connection,$query);
				if ($result) {
				echo "<script type='text/javascript'>alert('Product created successfully !')</script>";
...
<?php if (!empty($message)) {
			...
			?>								
								  ...
								  <input type="hidden" class="form-control"  value="<?php echo time(); ?>" name="time">
								    <input type="hidden" class="form-control"  value="<?php echo uniqid(); ?>" name="productcode">
								<!--  $required_fields = array('fullname','address','phone','email','gender','dob','password');-->
                                    ...
                                    <div class="">
										...
										<label> Select Sub Category</label>
										 ...
										 <div class="form-group">
                                           <label> Select Sub prim Category</label>
										 ...
										 <label> productcode </label>
                                            <input type="text" class="form-control" name="productcode" id="" placeholder="">
                                        </div>-->
										 <div class="form-group">
										  <label> new price </label>
                                            <input type="text" class="form-control" name="new_price" id="" placeholder="">
                                        </div>
										 <div class="form-group">
										 <label> old price </label>
                                            <input type="text" class="form-control" name="old_price" id="" placeholder="">
                                        </div>
										 <div class="form-group">
										 <label> name </label>
									...
									<!--	time,pr_category,pr_subcat,pr_subchildcat,productcode,new_price,old_price,name,	description,colors,pr_owner,		-->		   
										 ...
										 <div class="form-group">
										 <label> colors </label>
                                            <input type="text" class="form-control" name="colors" id="" placeholder="">
                                        </div>
										 <div class="form-group">
										 <label> pr_owner </label>
                                            <input type="text" class="form-control" name="pr_owner" id="" placeholder="">
                                        </div>
										 <!--<div class="form-group">
                                        ...
                                        <div class="form-group">
                           <button class="btn btn-success waves-effect waves-light" name="submit" value="submit" type="submit">Submit </button>
                                        </div>
                                    </div>
                                </form>
                            </div>
            ...
            <footer class="footer text-center">
                All Rights Reserved by Nigeria Food Market
