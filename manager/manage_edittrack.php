...
$pagetitle = "editslider";
?><?php include('includes/header.php'); ?>
 <?php admin_logged_in(); 
 //get_slide   slid
 
$advert = get_tracker($_GET['track']);
...
$db_images = "";
			...
			$required_fields = array('orderid','cur_loc','cur_date','time','description');
...
?>
	...
	<?php if (!empty($message)) {
			...
			?>							
						...
						<form class="m-t-20" method="post" action="manage_edittrack.php?track=<?php echo $_GET["track"]; ?>" enctype="multipart/form-data">		
								  <input type="hidden" class="form-control"  value="<?php echo time(); ?>" name="time">
								 
                                    <div class="">
                                        <div class="form-group">
										<span>orderid <em style="color:#FF0000;"><?php echo $advert_part['orderid']; ?></em></span>
                                            <input type="text" class="form-control" name="orderid" value="<?php echo $advert_part['orderid']; ?>"  placeholder="">
                                        </div>
										
										<div class="form-group">
										<span>current location <em style="color:#FF0000;"><?php echo $advert_part['cur_loc']; ?></em></span>
                                            <input type="text" class="form-control" name="cur_loc" value="<?php echo $advert_part['cur_loc']; ?>"  placeholder="">
                                        </div>
										
										<div class="form-group">
										<span>current date <em style="color:#FF0000;"><?php echo $advert_part['cur_date']; ?></em></span>
                                            <input type="text" class="form-control" name="cur_date" value="<?php echo $advert_part['cur_date']; ?>" placeholder="">
                                        </div>
																
										<div class="form-group">
										<span>description <em style="color:#FF0000;"><?php echo $advert_part['description']; ?></em></span>
                                            <input type="text" class="form-control" name="description" value="<?php echo $advert_part['description']; ?>" name="memcode" placeholder="">
                                        </div>
