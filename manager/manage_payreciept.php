...
redirect_to("manage_payreciept.php?status=asuccess");
}
}
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage payreciept</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage payreciept</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage payreciept&nbsp;&nbsp;&nbsp;&nbsp; <a href="addpayreciept.php"> </a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>payreciept";
...
$results = $connection->query("SELECT COUNT(*) FROM payreciept "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM payreciept WHERE status !=7 ORDER BY id  ASC LIMIT $page_position, $item_per_page");
...
<?php } } ?>
                                                ...
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_payreciept.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_payreciept.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_payreciept.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editpayreciept.php?cat=<?php echo $row['id']; ?>">Edit</a>)</td>
