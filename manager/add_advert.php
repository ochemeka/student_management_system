...
$db_images = "";
			...
			$required_fields = array('title','time');
			...
			if (empty($errors)) {
				...
				if ($result) {
				echo "<script type='text/javascript'>alert('Advert created successfully !')</script>";
					redirect_to('manage_advert.php');
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Advert</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
