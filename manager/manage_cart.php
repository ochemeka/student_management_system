...
redirect_to("manage_cart.php?status=asuccess");
}
}
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage cart&nbsp;&nbsp;&nbsp;&nbsp; <a href="addcart.php"> </a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>cart";
...
$results = $connection->query("SELECT COUNT(*) FROM cart "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM cart WHERE status !=7 ORDER BY cat_id ASC LIMIT $page_position, $item_per_page");
...
<?php } } ?>
											   ...
											   <td><?php echo $row['unit_price']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_cart.php?disapprove=<?php echo $row['cat_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_cart.php?approve=<?php echo $row['cat_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_cart.php?delete=<?php echo $row['cat_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editcart.php?cat=<?php echo $row['cat_id']; ?>">Edit</a>)</td>
