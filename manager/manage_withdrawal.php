...
redirect_to("manage_withdrawal.php?status=asuccess");
}
}
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage withdrawal</h4>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage withdrawal &nbsp;&nbsp;&nbsp;&nbsp; <a href="addexternal.php"><!--Add external--></a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>withdrawal";
...
$results = $connection->query("SELECT COUNT(*) FROM withdrawal "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM withdrawal WHERE status !=7 ORDER BY id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['amtwithdrw']; ?></td>
                                              
                                               <td><?php echo $row['username']; ?></td>
											   <td><?php echo $row['comment']; ?></td>
											   <td><?php echo $row['date']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_withdrawal.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_withdrawal.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_withdrawal.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editexternal.php?extn=<?php echo $row['id']; ?>">Edit</a>)</td>
