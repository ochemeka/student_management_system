                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                      ...
                      <a class="d-block w-100" data-toggle="collapse" href="#collapseTwo">
                          Second Term Subjects  <i  style="color:#FFF;">(Click Here for Dropdown)</i>
                        </a>
                      </h4>
                    </div>
...
$results = $connection->query("SELECT * FROM school_syllabus  WHERE  term = '$tm' AND class_title = '$pr' AND status != 7  ORDER BY week ASC LIMIT $page_position, $item_per_page");
