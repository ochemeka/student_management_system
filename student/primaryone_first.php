                  ...
                  <div class="card card-primary">
                    <div class="card-header">
                      ...
                      <a class="d-block w-100" data-toggle="collapse" href="#collapseTwo">
                          First Term Subjects  <i  style="color:#FFF;">(Click Here for Dropdown)</i>
                        </a>
                      </h4>
                    </div>
...
$results = $connection->query("SELECT * FROM school_syllabus  WHERE  term = '$tm'  AND status != 7  ORDER BY week ASC LIMIT $page_position, $item_per_page");
