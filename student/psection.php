        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            ...
            <li class="breadcrumb-item"><a href="../student/dashboard.php">Home</a></li>
              ...
              <li class="breadcrumb-item active">All Primary Classes</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
          ...
          <div class="col-12">
            <div class="card card-primary">
              <div class="card-header">
                <h3 class="card-title">All Primary Classes</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <div class="row">
...
$results = $connection->query("SELECT * FROM sub_category WHERE cat_id = 1 ORDER BY id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>  
                  <tr>
                      ...
                      <!-- <th><a href="prim_subject.php">View </a></th> -->
