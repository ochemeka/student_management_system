...
<?php
$pagetitle="Manage productreview";
?>
<?php include('includes/header.php'); ?>
 ...
 if (isset($_GET['approve'])) {
	// Success!
					$userid =  $_GET['approve'];
					$query0 = 	"UPDATE productreview SET 
						status = 1  
						WHERE id   = '$userid'";
...
redirect_to("manage_productreview.php?status=asuccess");
}
}
...
if (isset($_GET['disapprove'])) {
	// Success!
					...
					$query1 = 	"UPDATE productreview SET 
						status = 0   
						WHERE id  	 = '$userid'";
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage productreview</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage productreview</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage productreview &nbsp;&nbsp;&nbsp;&nbsp; <a href=""> </a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>productreview";
...
$results = $connection->query("SELECT * FROM productreview WHERE status !=7 ORDER BY id  ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
											   ...
											   <td><?php echo $row['reviewdetail']; ?></td>
											   <td><?php echo $row['rating']; ?></td>
											   <td><?php echo $row['time']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_productreview.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_productreview.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_productreview.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editproductreview.php?cat=<?php echo $row['id']; ?>">Edit</a>)</td>
