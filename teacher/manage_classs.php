...
//$db_images = "";
            ...
            //    $userid = $_SESSION['t_name'];
				...
				$query = "INSERT INTO current_term (
					 c_term, desp
						) VALUES (
                            '{$session}', '{$title}')";
...
if (isset($_GET['active'])) {
	// Success!
					$userid =  $_GET['active'];
					$query1 = 	"UPDATE current_term SET 
						    status = 1    
						WHERE id 	 = '$userid'";
...
redirect_to("term.php?status=asuccess");
}
}
...
if (isset($_GET['set'])) {
	// Success!
					$userid =  $_GET['set'];
					$query0 = 	"UPDATE current_term SET 
						 	status = 2  
						WHERE id 	 = '$userid'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
          <a href="term.php">  <span class="btn btn-primary"> Refresh </span> </a>
          </div>
          <!-- <div class="col-sm-6">
...
<div class="card-body">
   ...
   <div class="col-5">
        ...
        <p>  <input name="title" type="text" value="" placeholder=" Enter session title eg  this is First Term" class="form-control" /> </p>
        </div> 
        <div class="col-5 d-flex">
        <!-- <label for="exampleInputEmail1">Academic Session:</label> -->
         <input name="session" type="text" value="" placeholder="First-Term" class="form-control" />
...
$results = $connection->query("SELECT COUNT(*) FROM current_term "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM current_term   ORDER BY id ASC LIMIT $page_position, $item_per_page");
	 ...
	 ?>  
                  <tr>
                     ...
                     <p style="color:#F00;">Not Active</p>
                      ...
                      <td>(<?php if($row['status']==1){ ?><a href="term.php?deactive=<?php echo $row['id']; ?>" >De-activate</a><?php }else{ ?><a href="term.php?active=<?php echo $row['id']; ?>">Activate</a><?php } ?> )&nbsp;
                      (<a href="term.php?delete=<?php echo $row['id']; ?>" onClick="return confirm('Are you sure?');">Delete</a>)&nbsp;
                      </td>
