...
<?php include('includes/header.php'); ?>
 ...
 if (isset($_GET['approve'])) {
	// Success!
					$userid =  $_GET['approve'];
					$query0 = 	"UPDATE advertsright SET 
						r_status = 1  
						WHERE r_id  = '$userid'";
...
redirect_to("manage_rightbanner.php?status=asuccess");
}
}
...
if (isset($_GET['disapprove'])) {
	// Success!
					...
					$query1 = 	"UPDATE advertsright SET 
						r_status = 0   
						WHERE r_id 	 = '$userid'";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Advert Right</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Advert Right</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Advert Right &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href="addrightbanner.php"> Add Right Banner</a></h4>
...
$results = $connection->query("SELECT * FROM advertsright WHERE r_status !=7 ORDER BY r_id ASC LIMIT $page_position, $item_per_page");
...
<?php } } ?>
                                               ...
                                               <td><?php echo $row['r_time']; ?></td>
                                                <td>(<?php if($row['r_status']==1){ ?><a href="manage_rightbanner.php?disapprove=<?php echo $row['r_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_rightbanner.php?approve=<?php echo $row['r_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_rightbanner.php?delete=<?php echo $row['r_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editrightbanner.php?rban=<?php echo $row['r_id']; ?>">Edit</a>)</td>
