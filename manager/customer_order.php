...
//$product = get_productbyid($_GET['prdt']);
...
//$results = $connection->query("SELECT * FROM products WHERE id  = $cd ORDER BY id ASC LIMIT $page_position, $item_per_page");
$cd = $_GET['order'];
$results = $connection->query("SELECT * FROM custorders WHERE c_id  = $cd ORDER BY c_id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								<?php /*?><?php  													
                                ...
                                <h3 style="color:#FF0000;" class="card-title"> <?php echo $row['name']; ?> <!--Rounded Chair--></h3>
...
<img src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $advert_part['name']; ?>" height="100" width="100" />
<?php } } ?>   
                                    ...
                                    <div class="col-lg-9 col-md-9 col-sm-6">
                                        ...
                                        <h2 class="m-t-40">$<?php echo $row['new_price']; ?> <small class="text-success">($<?php echo $row['old_price']; ?>)</small></h2>							<br />
                                       <!-- <button class="btn btn-dark btn-rounded m-r-5" data-toggle="tooltip" title="" data-original-title="Add to cart"><i class="ti-shopping-cart"></i> </button>
                                        ...
                                        <h3 class="box-title m-t-40">&nbsp;Available Colour(s)</h3>
                                        <ul class="list-unstyled">
                                            <li><i class="fa fa-check text-success"></i>&nbsp;<?php echo $row['colors']; ?> </li>
