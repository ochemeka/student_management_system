...
redirect_to("manage_product.php?status=asuccess");
}
}
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Products  &nbsp; &nbsp; &nbsp; <a href="addproduct.php">Add Product</a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>products";
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
											...
											<?php //echo $row['catid']; ?>
												<?php $rm = $row['pr_category'];
												 $query = "SELECT * from category where cat_id = '$rm' order by cat_id";
												 $result = mysqli_query($connection, $query);
												 $cat_set = mysqli_fetch_array($result);
												 echo $cat_set['cat_name'];
												 ?>
												
												<?php //echo $row['pr_category']; ?>   </td>
												
												
												
                                           
										<td>	<?php //echo $row['model']; ?>
												<?php $rm = $row['pr_subcat'];
												 $query = "SELECT * from models where id = '$rm' order by id";
												 $result = mysqli_query($connection, $query);
												 $cat_set = mysqli_fetch_array($result);
												 echo $cat_set['model'];
												 ?>
												...
												<?php //echo $row['pr_subcat']; ?></td>
												<td>
												<?php //echo $row['model']; ?>
												<?php $rm = $row['pr_subchildcat'];
												 $query = "SELECT * from submodel where s_id = '$rm' order by s_id";
												 $result = mysqli_query($connection, $query);
												 $cat_set = mysqli_fetch_array($result);
												 echo $cat_set['submodel'];
												 ?>
												<?php //echo $row['pr_subchildcat']; ?></td>
												<td><?php echo $row['new_price']; ?></td>
												<?php /*?><td><?php echo $row['old_price']; ?></td><?php */?>
...
<img src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php //echo $row['gal_title']; ?>" height="100" width="100" />
<?php } } ?>
						<?php //echo substr($row['description'],0,200) ; ?></td>
                                                <td><?php echo timeAgo1(get_date_2a($row['time']));?><?php //echo $row['time']; ?><!--10-7-2017--></td>
                                                <td> 
												<?php //$status = $row['status']; ?>
                     <?php /*?> <?php if ($status == 0){ ?>       
                     <span class="label label-warning font-weight-100">Pending Approval</span>
					 <?php $status = $row['status']; ?>
                     <?php }  elseif ($status == 1)  {  ?>   
                       <span class="label label-success font-weight-100">Paid</span>   
                              <?php } ?><?php */?>
							  
							   <a href="products_detail.php?product=<?php echo $row['id']; ?>"> View Product</a>
							<!-- rooms.php?catid=<?php //echo $row["cat_id"]; ?>-->
							
												
												</td>
                                                <td>
												(<?php if($row['status']==1){ ?><a href="manage_product.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_product.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_product.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp; <br />(<a href="manage_editproduct.php?product=<?php echo $row['id']; ?>">Edit</a>)
												...
												<?php /*?><td><?php echo $row['id']; ?></td>
                                                <td><?php echo $row['pr_category']; ?></td>
												<td><?php echo $row['pr_subcat']; ?></td>
												<td><?php echo $row['pr_subchildcat']; ?></td>
...
<?php } } ?>
											   ...
											   <td><?php echo $row['pr_owner']; ?></td>
											   <td><?php echo $row['stock_status']; ?></td>
											   <td><?php echo $row['last_update']; ?></td>
											   <td><?php echo $row['topselling']; ?></td>
											   <td><?php echo $row['sponsored']; ?></td>
											   <td><?php echo $row['dealoffer']; ?></td>
											   <td><?php echo $row['salesdis']; ?></td>
											   <td><?php echo $row['spec_occ']; ?></td>
											   <td><?php echo $row['time']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_product.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_product.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_product.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editproduct.php?product=<?php echo $row['id']; ?>">Edit</a>)</td><?php */?>
