...
redirect_to("manage_setting.php?status=asuccess");
}
}
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                               <h4 class="card-title">Manage setting &nbsp;&nbsp;&nbsp;<a href="addslider.php"></a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>setting";
...
$results = $connection->query("SELECT COUNT(*) FROM setting "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM setting  ORDER BY id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['sitepath']; ?></td
                                                <td><?php echo $row['phone']; ?></td
												<td><?php echo $row['email']; ?></td>
                                                <td><?php echo $row['deliveryfee']; ?></td
												<td><?php echo $row['percentage']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_setting.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_setting.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_setting.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editsetting.php?stt=<?php echo $row['id']; ?>">Edit</a>)</td>
