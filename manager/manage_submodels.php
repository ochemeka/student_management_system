...
redirect_to("manage_submodels.php?status=asuccess");
}
}
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Sub Model&nbsp;&nbsp;&nbsp;&nbsp; <a href="addsubmodels.php">Add Sub Model</a></h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Sub Model</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
												...
												<?php /*?><?php $rsm = $row['model'];
												 $query = "SELECT * from models where id = '$rsm' order by id";
												 $result = mysqli_query($connection, $query);
												 $cat_set = mysqli_fetch_array($result);
												 echo $cat_set['model'];
												 ?><?php */?>
                                                ...
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_submodels.php?disapprove=<?php echo $row['s_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_submodels.php?approve=<?php echo $row['s_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_submodels.php?delete=<?php echo $row['s_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editsubmodel.php?mdl=<?php echo $row['s_id']; ?>">Edit</a>)</td>
