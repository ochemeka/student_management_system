...
$db_images = "";
			...
			//$required_fields = array('fullname','address','phone','email','gender','dob','password');model,cat_id
			...
			if (empty($errors)) {
				...
				if ($result) {
				echo "<script type='text/javascript'>alert('Model added successfully !')</script>";			
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Add Models</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Models</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
