...
redirect_to("manage_leftbanner.php?status=asuccess");
}
}
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Top Left Advert</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Top Left Advert</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Top Left Advert &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="addleftbanner.php">Add Left Banner</a></h4>
...
$results = $connection->query("SELECT * FROM advertsleft WHERE a_status !=7 ORDER BY a_id ASC LIMIT $page_position, $item_per_page");
...
<?php } } ?>
                                               ...
                                               <td><?php echo $row['description']; ?></td>
                                                <td>(<?php if($row['a_status']==1){ ?><a href="manage_leftbanner.php?disapprove=<?php echo $row['a_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_leftbanner.php?approve=<?php echo $row['a_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_leftbanner.php?delete=<?php echo $row['a_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editleftbanner.php?adv=<?php echo $row['a_id']; ?>">Edit</a>)</td>
