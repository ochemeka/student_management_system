                            ...
                            <nav class="main-menu navbar-expand-lg">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li class="current dropdown"><a href="#">Classes</a>
                                            <ul>
    ...
    <section class="classes-section classes-page-section sec-pad">
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 block-column">
                    <div class="inner-block wow fadeInUp" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <figure class="image-box"><a href="class-details.php"><img src="images/resource/class-4.jpg" alt=""></a></figure>
                        <div class="lower-content">
                            <div class="link-btn"><a href="class-details.php"><i class="flaticon-next"></i></a></div>
                            <h3><a href="class-details.php">Color Matching</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 block-column">
                    <div class="inner-block wow fadeInUp" data-wow-delay="300ms" data-wow-duration="1500ms">
                        <figure class="image-box"><a href="class-details.php"><img src="images/resource/class-5.jpg" alt=""></a></figure>
                        <div class="lower-content">
                            <div class="link-btn"><a href="class-details.php"><i class="flaticon-next"></i></a></div>
                            <h3><a href="class-details.php">Drawing & Painting</a></h3>
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 block-column">
                    <div class="inner-block wow fadeInUp" data-wow-delay="600ms" data-wow-duration="1500ms">
                        <figure class="image-box"><a href="class-details.php"><img src="images/resource/class-6.jpg" alt=""></a></figure>
                        <div class="lower-content">
                            <div class="link-btn"><a href="class-details.php"><i class="flaticon-next"></i></a></div>
                            <h3><a href="class-details.php">Letter Match</a></h3>
