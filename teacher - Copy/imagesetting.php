        ...
        <input type="text" value="<?php echo $teachpart['img_alt'];?>" class="form-control" id="field-1" name="title">
         ...
         <?php 
                            ...
                            <?php  if(strlen($img_url1)>4){  ?>
                              <a download href="<?php echo IMAGE_PATH; ?>uploads/<?php echo $img_url1;  ?>"><img download  src="<?php echo IMAGE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $teachpart['img_alt']; ?>" height="100" width="100" /></a>
