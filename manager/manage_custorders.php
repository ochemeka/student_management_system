...
redirect_to("manage_custorders.php?status=asuccess");
}
}
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Custorders</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Custorders</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Custorders  &nbsp; &nbsp; &nbsp; <a href="addcustorders.php"></a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>custorders";
...
$results = $connection->query("SELECT * FROM custorders WHERE status !=7 ORDER BY c_id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
                                                ...
                                                <td> <?php echo $row['prod_total']; ?><!--<img src="assets/images/gallery/chair.jpg" alt="iMac" width="80">--> </td>										
                                                <td><?php echo $row['total_price']; ?></td>
                                                <td><?php echo $row['address']; ?>,<?php echo $row['city']; ?>,<?php echo $row['state']; ?>,<?php echo $row['country']; ?></td>
                                                <td><?php echo $row['created']; ?><!--10-7-2017--></td>
                     ...
                     <?php }  elseif ($status == 1)  {  ?>   
                       <span class="label label-success font-weight-100">Paid</span>   
							  ...
							  <br /> <br /> <a href="customer_order.php?order=<?php echo $row["c_id"]; ?>"> View <br />Customer Order</a>
							<!-- rooms.php?catid=<?php //echo $row["cat_id"]; ?>-->
												
												</td>
                                                <td>
												(<?php if($row['status']==1){ ?><a href="manage_custorders.php?disapprove=<?php echo $row['c_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_custorders.php?approve=<?php echo $row['c_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_custorders.php?delete=<?php echo $row['c_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;<!--(<a href="manage_editcustorders.php?cust=<?php //echo $row['c_id']; ?>">Edit</a>)-->
												
												</td>
												
												
												<?php /*?><td><?php echo $row['c_id']; ?></td>
												...
												<td><?php echo $row['bustop']; ?></td>
						                         <td><?php echo $row['country']; ?></td>
											   <td><?php echo $row['state']; ?></td>
											   <td><?php echo $row['city']; ?></td>
											   <td><?php echo $row['c_comment']; ?></td>
											   <td><?php echo $row['total_price']; ?></td>
											   <td><?php echo $row['prod_total']; ?></td>
											   <td><?php echo $row['paym']; ?></td>
											   <td><?php echo $row['created']; ?></td>
											   <td><?php echo $row['modified']; ?></td>
											   <td><?php echo $row['bankpayref']; ?></td>
											   <td><?php echo $row['onlinepayref']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_custorders.php?disapprove=<?php echo $row['c_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_custorders.php?approve=<?php echo $row['c_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_custorders.php?delete=<?php echo $row['c_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editcustorders.php?cust=<?php echo $row['c_id']; ?>">Edit</a>)</td><?php */?>
												
                                                
                                                <?php /*?><td><?php echo $row['id']; ?></td>
													<td><?php echo $row['memcode']; ?></td>
													<td><?php echo $row['firstname']; ?></td>
													<td><?php echo $row['lastname']; ?></td>
													<td><?php echo $row['email']; ?></td>
													...
													<td><?php echo $row['address']; ?></td>
													<td><?php echo $row['city']; ?></td> 
													<td><?php echo $row['state']; ?></td></th>
													<td><?php echo $row['bustop']; ?></td> 
													<td><?php echo $row['country']; ?></td>
													<td><?php echo $row['sec_qst']; ?></td> 
													<td><?php echo $row['sec_ans']; ?></td>
													<td><?php echo $row['payment_mtd']; ?></td> 
													<td><?php echo $row['last_update']; ?></td>
													<td><?php echo $row['newsletter']; ?></td> 
													<td><?php echo $row['time']; ?></td></th>
