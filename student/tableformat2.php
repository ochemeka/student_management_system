      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <form method="POST" action="pdf_gen.php">
              <button  type="submit" name="btn_pdf" class="btn btn-primary">Download</button>
              
          </form>
        </div>


        <table id="example1" width="45%" border="0" cellpadding="10"  class="form-table">
          
          
  <tr>
    <td width="57%">Last Update:</td>
    <td width="57%"> <?php echo $stud_part['time']; ?></td>
  </tr>
  <tr>
    <td>Fullname:</td>
