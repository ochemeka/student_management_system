...
$pagetitle = "edit side banner";
?><?php include('includes/header.php'); ?>
 <?php admin_logged_in(); 
 
$advert = get_sideban($_GET['sban']);
...
$db_images = "";
			...
			$required_fields = array('name','desc');
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edit Side banner</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Side banner</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
               ...
               <!-- <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Side banner</h4>
	...
	<?php if (!empty($message)) {
			...
			?>							
						...
						<form class="m-t-20" method="post" action="manage_editsmallbanner.php?sban=<?php echo $_GET["sban"]; ?>" enctype="multipart/form-data">		
								 <!-- <input type="hidden" class="form-control"  value="<?php //echo time(); ?>" name="time">-->
								 
                                    <div class="">
                                        <div class="form-group">
										<span>Name <em style="color:#FF0000;"><?php echo $advert_part['name']; ?></em></span>
                                            <input type="text" class="form-control" name="name" value="<?php echo  $advert_part['name']; ?>" name="memcode" placeholder="Memcode">
                                        </div>
										
										 <div class="form-group">
										<!--<span>First Name <em style="color:#FF0000;"><?php //echo $advert_part['cat_image']; ?></em></span>-->
										<?php 
														$img_url = $advert_part["image"];
...
<img src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $cat_part['name']; ?>" height="100" width="100" />
<?php } } ?>   
										
										
                                            <!--<input type="text" class="form-control" name="firstname" value="<?php e//cho $advert_part['firstname']; ?>" name="firstname" placeholder="First Name">-->
                                        </div>
										
                                       
										
                                        <div class="form-group">
										<span>Size  <em style="color:#FF0000;">370px x 240px</em></span>
