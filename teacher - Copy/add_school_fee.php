...
$db_images = "";
        ...
        $passport = $db_images;
				...
				$description = stripslashes($_REQUEST['p_date']);
				$description = mysqli_real_escape_string($connection,$_POST['p_date']);
				
				$s_type = stripslashes($_REQUEST['description']);
				$s_type = mysqli_real_escape_string($connection,$_POST['description']);
        ...
        //         $stu_class = stripslashes($_REQUEST['class']);
				...
				$query = "INSERT INTO category (
					title, description, credit, debit, time, image,updated_at
						) VALUES (
...
<div class="card-body">
   ...
   <h3 style="color:#007bff;"> Add School Fees</h3><br>
     <span class="d-flex">   
   <div class="col-3">
        ...
        <input name="amount" type="text" value="" placeholder=" Payment Purpose eg. First term fees" class="form-control" />
         </div> 
         <div class="col-3">
  <label for="exampleInputEmail1">Payment date</label>    
        ...
        <label for="exampleInputEmail1">Upload Recipt:</label>
        <div class="d-flex">
