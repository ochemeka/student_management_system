...
$db_images = "";
			...
			if (empty($errors)) {
				...
				$query = 	"UPDATE advertsleft SET 
						 	advert_name = '{$advert_name}',
							advert_image = '{$passport}',
...
?>
               ...
               <!-- <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Advert</h4>
	...
	<?php if (!empty($message)) {
			...
			?>							
						...
						<form class="m-t-20" method="post" action="manage_editadvert.php?adv=<?php echo $_GET["adv"]; ?>" enctype="multipart/form-data">		
								 <!-- <input type="hidden" class="form-control"  value="<?php //echo time(); ?>" name="time">-->
								 
                                    <div class="">
                                        <div class="form-group">
										<span>Name <em style="color:#FF0000;"><?php echo $advert_part['advert_name']; ?></em></span>
                                            <input type="text" class="form-control" name="name" value="<?php echo $advert_part['advert_name']; ?>" name="memcode" placeholder="Memcode">
                                        </div>
										
										 <div class="form-group">
										<!--<span>First Name <em style="color:#FF0000;"><?php //echo $advert_part['cat_image']; ?></em></span>-->
										<?php 
														$img_url = $advert_part["advert_image"];
...
<img src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $cat_part['advert_name']; ?>" height="100" width="100" />
<?php } } ?>   
										
										
                                            <!--<input type="text" class="form-control" name="firstname" value="<?php //cho $advert_part['firstname']; ?>" name="firstname" placeholder="First Name">-->
                                        </div>
