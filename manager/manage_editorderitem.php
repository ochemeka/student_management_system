...
//$cattt = get_categ_id($_GET['catid']);
//$model_part = mysqli_fetch_array($cattt);

$advert = get_orderitem($_GET['ord']);
$model_part = mysqli_fetch_array($advert);
...
$db_images = "";
								...
								//invoiceID,agentID,product_id,p_name,category,pr_owner,price,quantity,total_price,created,order_time,payout
					$required_fields = array('invoiceID','agentID','product_id','p_name','category','pr_owner','price','quantity','total_price','created','order_time','payout');
				...
				$agentID = stripslashes($_REQUEST['agentID']);
				$agentID = mysqli_real_escape_string($connection,$_POST['agentID']);
				...
				$order_time = stripslashes($_REQUEST['order_time']);
				$order_time = mysqli_real_escape_string($connection,$_POST['order_time']);
				$payout= stripslashes($_REQUEST['payout']);
				$payout = mysqli_real_escape_string($connection,$_POST['payout']);
				...
				redirect_to('manage_orderitem.php');
...
?>
        ...
        <div class="page-wrapper">
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edit orderitem</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit orderitem</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
               ...
               <!-- <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit orderitem</h4>
								
							
                                <!--<form class="m-t-20" method="post" enctype="multipart/form-data"> manage_editorderitem.php?mdl -->
						<form class="m-t-20" method="post" action="manage_editorderitem.php?ord=<?php echo $_GET["ord"]; ?>" enctype="multipart/form-data">		
			...
			?>	
								 ...
								 <?php /*?> <input type="hidden" class="form-control"  value="<?php echo time(); ?>" name="time">
								 <input type="hidden" class="form-control"  value="<?php echo time(); ?>" name="time"><?php */?>
                                  	
                                       
                                        <div class="form-group">   	
										<span>invoiceID <em style="color:#FF0000;"><?php echo $model_part['invoiceID']; ?></em></span>
                                            <input type="text" class="form-control" name="invoiceID" value="<?php echo $model_part['invoiceID']; ?>"  placeholder="">
                                        </div>
										
										<div class="form-group">
										<span>agentID <em style="color:#FF0000;"><?php echo $model_part['agentID']; ?></em></span>
                                            <input type="text" class="form-control" name="agentID" value="<?php echo $model_part['agentID']; ?>" placeholder="">
                                        </div>
                                     
										<div class="form-group">
										<span>product_id <em style="color:#FF0000;"><?php echo $model_part['product_id']; ?></em></span>
                                            <input type="text" class="form-control" name="product_id" value="<?php echo $model_part['product_id']; ?>" placeholder="">
                                        </div>
                                       
										<div class="form-group">
										<span>p_name <em style="color:#FF0000;"><?php echo $model_part['p_name']; ?></em></span>
                                            <input type="text" class="form-control" name="p_name" value="<?php echo $model_part['p_name']; ?>" placeholder="">
                                        </div>
											
										<div class="form-group">
										<span>category <em style="color:#FF0000;"><?php echo $model_part['category']; ?></em></span>
                                            <input type="text" class="form-control" name="category" value="<?php echo $model_part['category']; ?>" placeholder="">
                                        </div>
										
										<div class="form-group">
										<span>pr_owner <em style="color:#FF0000;"><?php echo $model_part['pr_owner']; ?></em></span>
                                            <input type="text" class="form-control" name="pr_owner" value="<?php echo $model_part['pr_owner']; ?>" placeholder="">
                                        </div>
										
										<div class="form-group">
										<span>price <em style="color:#FF0000;"><?php echo $model_part['price']; ?></em></span>
                                            <input type="text" class="form-control" name="price" value="<?php echo $model_part['price']; ?>" placeholder="">
                                        </div>
										
										<div class="form-group">
										<span>quantity <em style="color:#FF0000;"><?php echo $model_part['quantity']; ?></em></span>
                                            <input type="text" class="form-control" name="quantity" value="<?php echo $model_part['quantity']; ?>" placeholder="">
                                        </div>
										
										<div class="form-group">
										<span>total_price <em style="color:#FF0000;"><?php echo $model_part['total_price']; ?></em></span>
                                            <input type="text" class="form-control" name="total_price" value="<?php echo $model_part['total_price']; ?>" placeholder="">
                                        </div>
										 
										<div class="form-group">
										<span>created <em style="color:#FF0000;"><?php echo $model_part['created']; ?></em></span>
                                            <input type="text" class="form-control" name="created" value="<?php echo $model_part['created']; ?>" placeholder="">
                                        </div>
										
										<div class="form-group">
										<span>order_time <em style="color:#FF0000;"><?php echo $model_part['order_time']; ?></em></span>
                                            <input type="text" class="form-control" name="order_time" value="<?php echo $model_part['order_time']; ?>" placeholder="">
                                        </div>
										
										<div class="form-group">
										<span>payout <em style="color:#FF0000;"><?php echo $model_part['payout']; ?></em></span>
                                            <input type="text" class="form-control" name="payout" value="<?php echo $model_part['payout']; ?>" placeholder="">
                                        </div>
