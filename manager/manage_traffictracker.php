...
<?php
$pagetitle="Manage manage_traffictracker";
?>
<?php include('includes/header.php'); ?>
 ...
 if (isset($_GET['approve'])) {
	// Success!
					$userid =  $_GET['approve'];
					$query0 = 	"UPDATE traffictracker SET 
						status = 1  
						WHERE id  = '$userid'";
...
redirect_to("manage_traffictracker.php?status=asuccess");
}
}
...
if (isset($_GET['disapprove'])) {
	// Success!
					...
					$query1 = 	"UPDATE traffictracker SET 
						status = 0   
						WHERE id 	 = '$userid'";
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Traffictracker</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Traffictracker</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Traffictracker  &nbsp; &nbsp; &nbsp; <a href="addproduct.php"> </a></h4>
                                    ...
                                    <table id="alt_pagination" class="table table-striped table-bordered display" style="width:100%">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>keyword</th>
												<th>pageViewed</th>
                                                <th>adwordsKeyword</th>
												<th>adwordsMatchType </th>
                                                <th>adwordsPosition</th>
												<th>firstVisit </th>
												<th>previousVisit </th>
												<th>currentVisit </th>
												<th>timesVisited </th>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>traffictracker";
...
$results = $connection->query("SELECT COUNT(*) FROM traffictracker "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM traffictracker  ORDER BY id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
                                                ...
                                                <td><?php echo $row['identifyUser']; ?></td>
												<td><?php echo $row['medium']; ?></td>
												<td><?php echo $row['source']; ?></td>
												<td><?php echo $row['content']; ?></td>
												<td><?php echo $row['campaign']; ?></td>
												<td><?php echo $row['keyword']; ?></td>
												<td><?php echo $row['pageViewed']; ?></td>
                                               <td><?php echo $row['adwordsKeyword']; ?></td>
											   <td><?php echo $row['adwordsMatchType']; ?></td>
											   <td><?php echo $row['adwordsPosition']; ?></td>
											   <td><?php echo $row['firstVisit']; ?></td>
											   <td><?php echo $row['previousVisit']; ?></td>
											   <td><?php echo $row['currentVisit']; ?></td>
											   <td><?php echo $row['timesVisited']; ?></td>
											   <td><?php echo $row['pagesViewed']; ?></td>
											   <td><?php echo $row['userIp']; ?></td>
											  <?php /*?> <td><?php echo $row['timestamp']; ?></td><?php */?>
                                                <td>(<?php if($row['timestamp']==1){ ?><a href="manage_traffictracker.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_traffictracker.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_traffictracker.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editproduct.php?ban=<?php echo $row['id']; ?>">Edit</a>)</td>
