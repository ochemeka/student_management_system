          ...
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">All Modules For Primary-1</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                           ...
                           <button oncontextmenu="return false" type="button" class="btn btn-success toastrDefaultSuccess">
                             ...
                             <?php 
                                   ...
                                   <?php  if(strlen($img_url1)>4){  ?>
                                     <a type="pdf" download="<?php echo $row['sub_name']; ?>&nbsp;<?php echo $row['week']; ?> " href="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>">
