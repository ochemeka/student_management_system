...
redirect_to("manage_recads.php?status=asuccess");
}
}
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage recadstbl</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage recadstbl</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage recadstbl &nbsp;&nbsp;&nbsp;&nbsp;<a href=""></a></h4>
...
$results = $connection->query("SELECT * FROM recadstbl WHERE r_status !=7 ORDER BY r_id ASC LIMIT $page_position, $item_per_page");
...
<?php } } ?>
                                               ...
                                               <td><?php echo timeAgo1(get_date_2a($row['r_time']));?></td>
                                                <td>(<?php if($row['r_status']==1){ ?><a href="manage_recads.php?disapprove=<?php echo $row['r_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_recads.php?approve=<?php echo $row['r_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_recads.php?delete=<?php echo $row['r_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editrecads.php?ads=<?php echo $row['r_id']; ?>">Edit</a>)</td>
                                                ...
                                                <?php /*?><td><?php echo $row['id']; ?></td>
													...
													<td><?php echo $row['r_status']; ?></td><?php */?>
