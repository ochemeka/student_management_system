...
$db_images = "";
      ...
      $required_fields = array('name','teacher');
        ...
        $time = date("Y-m-d H:i:s");
			...
			//	 '{$userid}', '{$title}', '{$memcode}', '{$description}','{$stu_class}','{$s_type}')";
             ...
             updated_at = '{$time}'
				...
				redirect_to('manage_allsubject.php');
...
<div class="card-body">
   ...
   <div class="form-group">
                   ...
                   <label style="color:#000;">Select Teacher:&nbsp; <span style="color:#F00;"><?php echo $sub_part['sub_teacher'];?> </span></label>
              <select type="text" class="form-control"  placeholder="Enter Teachers Name" name="teacher">
                  <option value="0">Select Teacher </option>
                  <?php  													
											$query = "SELECT * from teacher_tbl order by t_id";
											$result = mysqli_query($connection,$query);
											while($cat_set=mysqli_fetch_array($result)) {
											echo "<option value=$cat_set[t_name]>$cat_set[t_name]</option>";
											}
											?>
                  </select>
        
            <label style="color:#000;">Select Subject;&nbsp;<span style="color:#F00;"> <?php echo $sub_part['sub_name'];?></span></label>
                  <input name="name" type="text" value="<?php echo $sub_part['sub_name'];?>" placeholder=" Enter Subject name" class="form-control" />
          <!-- <label style="color:#000;">Select Subject;&nbsp;<span style="color:#F00;"> <?php echo $sub_part['sub_name'];?></span></label>
              <select type="text" class="form-control"  placeholder="Enter Subject Name" name="name">
