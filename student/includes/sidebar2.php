<aside style="background-color:#272e48;" class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
 ...
 <?php 
      //   if($total > "69-100"){
			...
			// }
                            ...
                            <img class="img-circle elevation-2" src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $stud_part['img_alt']; ?>" height="100" width="200" />
                            <?php } } ?>   
        ...
        <div class="info">
        <a href="dashboard.php" class="d-block"><?php echo $stud_part['username'];?></a>
        </div>
      </div>
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
         ...
         <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
            <!-- <li class="nav-item">
                <a href="check_exams" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Exams Result</p>
                </a>
              </li> -->
              <li class="nav-item">
                <a href="manage_scores.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Quick Result Check </p>
                </a>
              </li>
             <li class="nav-item">
                <a href="check_scores.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Check Scores</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="allclasses.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>All Classes</p>
                </a>
              </li>
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="classmate.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Check Class Mate</p>
                </a>
              </li>
              <!--<li class="nav-item">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="modules_category.php" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Module</p>
                </a>
              </li>
