...
redirect_to("manage_orders.php?status=asuccess");
}
}
...
?>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage orders&nbsp;&nbsp;&nbsp;&nbsp; <a href="addexternal.php"><!--Add external--></a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>orders";
...
$results = $connection->query("SELECT COUNT(*) FROM orders "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM orders WHERE status !=7 ORDER BY o_id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
                                                ...
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_orders.php?disapprove=<?php echo $row['o_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_orders.php?approve=<?php echo $row['o_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_orders.php?delete=<?php echo $row['o_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editexternal.php?extn=<?php echo $row['o_id']; ?>">Edit</a>)</td>
