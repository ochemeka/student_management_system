...
<div class="main">
<h1>Student Online Assessment</h1>
	...
	<form action="" method="post">
        ...
        <br/>
	   <p style="font-size: 16px; text-align: center;">Not Registered? <a style="text-decoration: none" href="register.php">Register</a> Here</p>
        <br/>
