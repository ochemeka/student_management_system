...
//$db_images = "";
    ...
    -->  */
			$required_fields = array('lname','fname','username','gender','phone','dob',
...
?>              <!-- form start 
			...
			?>
                ...
                <input type="text" value="<?php echo $stud_part['fname']; ?>" name="fname" class="form-control" id="exampleInputEmail1" placeholder="Enter Fullname" required >
                </div>

                 <div class="form-group">
                <label for="exampleInputEmail1">Last Name</label>
                <input type="text" value="<?php echo $stud_part['lname']; ?>" name="lname" class="form-control" id="exampleInputEmail1" placeholder="Enter Fullname" required >
                </div>
                ...
                <div class="form-group"> <label for="exampleInputEmail1">Select Gender</label>
                  <input type="text" value="<?php echo $stud_part['gender']; ?>" name="gender" class="form-control" id="exampleInputEmail1" placeholder="Enter Username" required >
