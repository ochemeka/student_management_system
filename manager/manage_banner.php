...
redirect_to("manage_banner.php?status=asuccess");
}
}
...
$results = $connection->query("SELECT COUNT(*) FROM banner "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM banner WHERE status !=7 ORDER BY id ASC LIMIT $page_position, $item_per_page");
...
<?php } } ?>
                                               ...
                                               <td><?php echo $row['time']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_banner.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_banner.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_banner.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editbanner.php?ban=<?php echo $row['id']; ?>">Edit</a>)</td>
