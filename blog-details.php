                        ...
                        <div class="inner-box">
                            <div class="content-style-one">
                                <div class="top-content">
                                    <h4>10 July, 2019</h4>
                                    <h1>The Indoor Activities for Everyone</h1>
                                ...
                                <figure class="image-box"><img src="images/resource/blog-details.jpg" alt=""></figure>
                                <div class="text">
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 sidebar-side">
                    <div class="sidebar">
                        ...
                        <div class="sidebar-post sidebar-widget">
                            ...
                            <div class="widget-content">
                                <div class="post">
                                    <figure class="image"><a href="blog-details.php"><img src="images/resource/post-1.png" alt=""></a></figure>
                                    <span class="post-date">April 20, 2019</span>
                                    <h4><a href="blog-details.php">Consequntur magni dolore eos qui.</a></h4>
                                </div>
                                <div class="post">
                                    <figure class="image"><a href="blog-details.php"><img src="images/resource/post-2.png" alt=""></a></figure>
                                    <span class="post-date">April 19, 2019</span>
                                    <h4><a href="blog-details.php">Magni dolore eos qui ratione seque.</a></h4>
                                </div>
                                <div class="post">
                                    <figure class="image"><a href="blog-details.php"><img src="images/resource/post-3.png" alt=""></a></figure>
                                    <span class="post-date">April 18, 2019</span>
                                    <h4><a href="blog-details.php">Ratone magni dolore eos qui ratione.</a></h4>
                                </div>
                            </div>
                        </div>
