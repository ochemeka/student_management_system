...
$db_images = "";
			...
			//$required_fields = array('fullname','address','phone','email','gender','dob','password');model,submodel,cat_id
			$required_fields = array('cat_id','submodel','model');
			...
			if (empty($errors)) {
				...
				$submodel = stripslashes($_REQUEST['submodel']);
				$submodel = mysqli_real_escape_string($connection,$_POST['submodel']);
				...
				//$stid = mysql_prep($_GET['pid']);
					...
					/*"
					*/
				$query = "INSERT INTO submodel (
						catid, model, submodel
						) VALUES (
							'{$cat_id}', '{$model}', '{$submodel}')";
         
				$result = mysqli_query($connection,$query);
				if ($result) {
				echo "<script type='text/javascript'>alert('Sub Model added successfully !')</script>";			
				redirect_to('manage_submodels.php');
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Add Submodels</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add Submodels</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add Submodels</h4>
			...
			?>									
								  ...
								  <?php */?>
                                    <div class="">
										...
										<div class="form-group">
										<span style="color:#0033FF;">Sub Model</span>
                                           <input type="text" class="form-control" name="submodel" placeholder="Add Sub Model">
                                       	</div>
										<div class="form-group">
										<span style="color:#0033FF;">Select Category</span>
										...
										<div class="form-group">
										<span style="color:#0033FF;">Select Model</span>
                                           <select type="text" class="form-control"  placeholder="Enter Name" name="model">
											<option value="0">Select your model</option>
											
											<?php /*$rm = $row['model'];
												 $query = "SELECT * from model where id = '$rm' order by id";
												 $result = mysqli_query($connection, $query);
											...
											$result = mysqli_query($connection,$query);
											while($cat_set=mysqli_fetch_array($result)) {
											echo "<option value=$cat_set[model]>$cat_set[model]</option>";
											}
											?>
											<?php  													
