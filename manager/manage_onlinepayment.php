...
<?php
$pagetitle="Manage onlinepayment";
?>
<?php include('includes/header.php'); ?>
 ...
 if (isset($_GET['approve'])) {
	// Success!
					$userid =  $_GET['approve'];
					$query0 = 	"UPDATE onlinepayment SET 
						status = 1  
						WHERE p_id  = '$userid'";
...
redirect_to("manage_onlinepayment.php?status=asuccess");
}
}
...
if (isset($_GET['disapprove'])) {
	// Success!
					...
					$query1 = 	"UPDATE onlinepayment SET 
						status = 0   
						WHERE p_id 	 = '$userid'";
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage onlinepayment</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage onlinepayment</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage onlinepayment</h4>
...
$results = $connection->query("SELECT COUNT(*) FROM onlinepayment "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM onlinepayment WHERE status !=7 ORDER BY p_id ASC LIMIT $page_position, $item_per_page");
	 ...
	 ?>								
                                            ...
                                            <tr>
                                               ...
                                               <td><?php echo $row['pay_reference']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_onlinepayment.php?disapprove=<?php echo $row['p_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_onlinepayment.php?approve=<?php echo $row['p_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_onlinepayment.php?delete=<?php echo $row['p_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editonlinepayment.php?ban=<?php echo $row['p_id']; ?>">Edit</a>)</td>
