            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage testimony</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage testimony</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage testimony &nbsp;&nbsp;&nbsp;&nbsp; <a href=""><!--Add external--></a></h4>
...
$results = $connection->query("SELECT * FROM testimony WHERE status !=7 ORDER BY t_id ASC LIMIT $page_position, $item_per_page");
	 ...
	 ?>								
                                            ...
                                            <tr>
											   ...
											   <td><?php echo timeAgo1(get_date_2a($row['time']));?></td>
                                                ...
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_testimony.php?disapprove=<?php echo $row['t_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_testimony.php?approve=<?php echo $row['t_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_testimony.php?delete=<?php echo $row['t_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_edittestimony.php?testm=<?php echo $row['t_id']; ?>">Edit</a>)</td>
