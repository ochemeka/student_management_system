...
$errors = array();
		...
		if ( empty($errors) ) {
			...
			$query .= "AND t_id = '{$_SESSION['user_id']}' ";
			$query .= "LIMIT 1";
			...
			?>
                ...
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputEmail1"><strong>Old Password:   </strong><?php echo $teachpart['temp_pass'];?></label>
                  ...
                  <div class="form-group">
                    ...
                    <input name="pass_nw2" type="password" placeholder="Confirm New Password" class="form-control"/>   
                  </div>
