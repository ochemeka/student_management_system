...
//$cat_part = mysqli_fetch_array($cattt);

$advert = get_model_id($_GET['mdl']);
...
$db_images = "";
			...
			$required_fields = array('cat_id','model');
                    ...
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <!--<form class="m-t-20" method="post" enctype="multipart/form-data"> manage_editmodel.php?mdl -->
						<form class="m-t-20" method="post" action="manage_editmodel.php?mdl=<?php echo $_GET["mdl"]; ?>" enctype="multipart/form-data">		
			...
			?>	
								 ...
								 <!-- <input type="hidden" class="form-control"  value="<?php //echo time(); ?>" name="time">-->
                                    ...
                                    <div class="">
										...
										<div class="form-group">
										<span>category <em style="color:#FF0000;"><?php echo $cat_part['category']; ?></em></span>
						...
						?>
										...
										<span>Name <em style="color:#FF0000;"><?php echo $model_part['model']; ?></em></span>
										<input type="text" class="form-control" name="model" value="<?php echo $model_part['model']; ?>"  placeholder="Memcode">
                                            <?php /*?><input type="text" class="form-control" name="name" value="<?php echo $model_part['model']; ?>" name="memcode" placeholder="Memcode"><?php */?>
											<?php /*?> <select type="text" class="form-control"  placeholder="Enter Name" name="model">
					  	<option value="0">Select your category</option>
											<?php  													
