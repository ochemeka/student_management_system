    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <?php 
                            ...
                            <img class="img-circle elevation-2" src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $teachpart['img_alt']; ?>" height="100" width="200" />
                            <?php } } ?>   
         ...
         <!-- <li class="nav-item">
          ...
          <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="addscores_secondary.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Seconday Scores</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="addscores_primary.php" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Add Primary Scores</p>
                </a>
              </li>
              <li class="nav-item">
