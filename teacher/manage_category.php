...
<div class="card-body">
   ...
   <h3 style="color:#007bff;"> Please Add Category</h3>
     <span class="d-flex">   
   <div class="col-4">
        <!-- <label for="exampleInputEmail1">Title:</label> -->
        <!-- <p>  <label for="exampleInputEmail1">Class details:</label>     -->
              <input name="description" type="text" value="" placeholder=" Enter category details eg primary/ secondary" class="form-control" />
...
$results = $connection->query("SELECT * FROM category ORDER BY cat_id ASC LIMIT $page_position, $item_per_page");
...
<img src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php //echo $row['email']; ?>" height="60" width="60" />
<?php } } ?>   
        <br />
