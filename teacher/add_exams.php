...
//											 }
			...
			$searchq = preg_replace("#[^0-9a-z]#i","",$searchq);
			 ...
			 $con = mysqli_connect("localhost","root","emeka1109", "school_management_system");
			  ...
			  if (isset($_GET['search'])) {
					...
					$query = "SELECT * from student_tbl WHERE class = 1 AND CONCAT(fname) LIKE '%$filevalue%' ORDER BY stud_id ASC";
   ...
   <form action="" method="post" enctype="multipart/form-data" > 	             
                  <td><?= $items['stud_id']; ?></td>    
                  <td><?= $items['fname']; ?> </td> 
                  <td><input type="text" name="test1" class="form-control" id="exampleInputEmail1" required /> </td>  
									<td><input type="text" name="test2" class="form-control" id="exampleInputEmail1" required />     </td>  
									<td><input type="text" name="exams" class="form-control" id="exampleInputEmail1" required /></td>  
