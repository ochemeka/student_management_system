  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h4>Profile of  <?php echo $teachpart['username']; ?></h4>
          </div>
          <div class="col-sm-6">
...
?> </small>
              ...
              <div class="row">
                <div class="col-12 table-responsive">
                      ...
                      <form action="<?php if(isset($_GET['search'])){echo $_GET['search']; } ?>" method="GET" enctype="multipart/form-data">
                      
                              <div class="input-group mb-3">
                              <input type="text" class="form-control" name="search" value="" placeholder="Search Username" >
                              &nbsp; &nbsp;
         ...
         if (isset($_POST['search'])) {
			...
			$searchq = preg_replace("#[^0-9a-z]#i","",$searchq);
			 ...
			 $con = mysqli_connect("localhost","root","emeka1109", "school_management_system");
              ...
              $cl = 'class';
					$query = "SELECT * from student_tbl WHERE class = $cl AND status = 1 AND CONCAT(fname,phone,email) LIKE '%$filevalue%' ORDER BY stud_id ASC";
