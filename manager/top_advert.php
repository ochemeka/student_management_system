...
redirect_to("top_advert.php?status=asuccess");
}
}
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Top Ads</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Top Ads</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Top Ads</h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>top_adstbl";
...
$results = $connection->query("SELECT * FROM top_adstbl WHERE status !=7 ORDER BY id ASC LIMIT $page_position, $item_per_page");
...
<?php } } ?>
                                               ...
                                               <td><?php echo timeAgo1(get_date_2a($row['time']));?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="top_advert.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="top_advert.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="top_advert.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_edittop_advert.php?ban=<?php echo $row['id']; ?>">Edit</a>)</td>
