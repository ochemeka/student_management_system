...
$db_images = "";
								 	...
								 	//time,name,category
			$required_fields = array('time','name','category');
			...
			if (empty($errors)) {
				...
				$query = 	"UPDATE catadstbl SET 
						 	 	category = '{$advert_name}',
							 	name = '{$passport}',
								image = '{$passport}',
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edit Catads</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Catads</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
               ...
               <!-- <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit catads</h4>
								
							
                                <!--<form class="m-t-20" method="post" enctype="multipart/form-data">-->
						<form class="m-t-20" method="post" action="manage_editcatads.php?ads=<?php echo $_GET["ads"]; ?>" enctype="multipart/form-data">		
			...
			?>	
								  ...
								  <input type="hidden" class="form-control"  value="<?php echo time(); ?>" name="time">
                                    ...
                                    <div class="">
										...
										<span>Name <em style="color:#FF0000;"><?php echo $cat_part['category']; ?></em></span>
                                            <input type="text" class="form-control" name="category" value="<?php echo $cat_part['category']; ?>" name="memcode" placeholder="Memcode">
                                        </div>
										<div class="form-group">
										<span>Name <em style="color:#FF0000;"><?php echo $cat_part['name']; ?></em></span>
                                            <input type="text" class="form-control" name="name" value="<?php echo $cat_part['name']; ?>" name="memcode" placeholder="Memcode">
                                        </div>
										
										 <div class="form-group">
										<!--<span>First Name <em style="color:#FF0000;"><?php echo $cat_part['image']; ?></em></span>-->
										<?php 
														$img_url = $cat_part["image"];
...
<img src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $cat_part['image']; ?>" height="100" width="100" />
<?php } } ?>   
										
										
                                            <!--<input type="text" class="form-control" name="firstname" value="<?php //cho $cat_part['firstname']; ?>" name="firstname" placeholder="First Name">-->
                                        </div>
