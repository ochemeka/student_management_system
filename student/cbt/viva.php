...
?>
    ...
    <div class="viva_main">
        <h1 style="color: blue;">Online Exam System - Interview Board</h1>
        <p style="text-align: center">Congratulation! You are selected for an interview</p>
        ...
        <div class="segment_viva">
            <form action="" method="post">
                <table style="padding-left: 60px; padding-top: 35px">
                    ...
                    <tr>
                        <td>Facebook ID:</td>
                        <td><input name="facebook" type="text" id="facebook" required="" placeholder="Like: fb.com/username"></td>
                    </tr>
                    <tr>
                        <td>Skype ID:</td>
