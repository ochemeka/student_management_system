...
$db_images = "";
			...
			//$required_fields = array('fullname','address','phone','email','gender','dob','password');time,category,name
			$required_fields = array('time','category','name');
			...
			if (empty($errors)) {
				...
				$query = "INSERT INTO catadstbl (
						category,name,image,time
							...
							'{$category}', '{$name}', '{$passport}', '{$time}')";
         
				$result = mysqli_query($connection,$query);
				if ($result) {
				echo "<script type='text/javascript'>alert('Table added successfully !')</script>";			
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Add addcatads</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Add addcatads</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add addcatads</h4>
