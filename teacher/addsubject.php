...
//$db_images = "";
        ...
        $time = date("Y-m-d H:i:s");
				...
				$query = "INSERT INTO allsubject (
					   sub_name, sub_teacher, uploaded
						) VALUES (
                            '{$title}', '{$teacher}','{$time}')";
...
<div class="card-body">
   <div class="form-group">
        ...
        <input name="name" type="text" value="" placeholder=" Enter Subject name" class="form-control" /> -->
        ...
        <div class="form-group">
              ...
              <input name="name" type="text" value="" placeholder=" Enter Subject Name" class="form-control" />
                  ...
                  <label style="color:#000;"><span>Select Teacher </span></label>
