...
$db_images = "";
			...
			if (empty($errors)) {
				...
				redirect_to('manage_longbanner.php');
               ...
               <!-- <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
						...
						<form class="m-t-20" method="post" action="manage_editlongbanner.php?lban=<?php echo $_GET["lban"]; ?>" enctype="multipart/form-data">		
...
<img src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php echo $cat_part['name']; ?>" height="100" width="50%" />
<?php } } ?>   
                                        ...
                                        <div class="form-group">
									<span>Image Size <em style="color:#FF0000;">570 x 168 px</em></span>
