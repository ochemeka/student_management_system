...
<?php include('includes/header.php'); ?>
 ...
 if (isset($_GET['approve'])) {
	// Success!
			...
			if($result0)
			{ 
/*echo "<script type='text/javascript'>alert('Approved Updated !')</script>";*/

redirect_to("manage_orderitem.php?status=asuccess");
}
}
...
if (isset($_GET['disapprove'])) {
	// Success!
			...
			if($result1)
			{ 
/*echo "<script type='text/javascript'>alert('Disapove Updated !')</script>";*/
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Order Item</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Order Item</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Order Item  &nbsp; &nbsp; &nbsp; <a href="addorderitem.php"><!--Add Orderitem--></a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>order_items";
...
$results = $connection->query("SELECT * FROM order_items WHERE status !=7 ORDER BY ord_id ASC LIMIT $page_position, $item_per_page");
	 ...
	 ?>								
                                            ...
                                            <tr>
											   ...
											   <td><?php echo $row['payout']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_orderitem.php?disapprove=<?php echo $row['ord_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_orderitem.php?approve=<?php echo $row['ord_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_orderitem.php?delete=<?php echo $row['ord_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editorderitem.php?ord=<?php echo $row['ord_id']; ?>">Edit</a>)</td>
