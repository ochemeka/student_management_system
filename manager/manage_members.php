	 ...
	 ?>								
                                            ...
                                            <tr>
											 <td><?php echo $row['id']; ?></td>
                                                ...
                                                <?php /*?><td><?php echo $row['password']; ?></td>
												 <td><?php echo $row['temp_pass']; ?></td><?php */?>
                                               ...
                                               <?php /*?> <td><?php echo $row['city']; ?></td>
                                                ...
                                                <td><?php echo $row['sec_ans']; ?></td>
												 <td><?php echo $row['payment_mtd']; ?></td><?php */?>
                                            <?php /*?>     <td><?php echo $row['last_update']; ?></td>
                                               <td><?php echo $row['newsletter']; ?></td><?php */?>
