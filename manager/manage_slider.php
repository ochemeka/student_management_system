            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                               <h4 class="card-title">Manage slider &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="addslider.php">Add Slider</a></h4>
...
<?php } } ?>
                                               ...
                                               <td><?php echo timeAgo1(get_date_2a($row['s_time']));?></td>
                                                <td>(<?php if($row['s_status']==1){ ?><a href="manage_slider.php?disapprove=<?php echo $row['s_id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_slider.php?approve=<?php echo $row['s_id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_slider.php?delete=<?php echo $row['s_id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editslider.php?slide=<?php echo $row['s_id']; ?>">Edit</a>)</td>
