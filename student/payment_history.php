            ...
            <!--   <div class="card-header">
              ...
              <div class="row">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  <thead>
                  <strong> Transaction History     <span style="color:#F00;">&nbsp;
            <?php 
...
?>    
                ...
                <div class="col-12">
                  <a  class="btn btn-primary" href="print_payment_history.php" rel="noopener" target="_blank" class="btn btn-default"><i class="fas fa-print"></i>  <i class="fas fa-download"></i>Print</a>
