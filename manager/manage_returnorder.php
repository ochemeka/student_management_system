...
redirect_to("manage_returnorder.php?status=asuccess");
}
}
...
?>
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Returnorder</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Returnorder</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Returnorder  &nbsp; &nbsp; &nbsp; <a href="addproduct.php"></a></h4>
	...
	<?php  
	 ...
	 $page_url           = "<?php echo ADMIN_PATH ; ?>returnorder";
...
$results = $connection->query("SELECT COUNT(*) FROM returnorder "); //get total number of records from database
...
$results = $connection->query("SELECT * FROM returnorder WHERE status !=7 ORDER BY id ASC LIMIT $page_position, $item_per_page");
...
while($row = $results->fetch_assoc()) {
	 ...
	 ?>								
                                            ...
                                            <tr>
											   ...
											   <td><?php echo $row['prcode']; ?></td>
											   <td><?php echo $row['quantity']; ?></td>
											   <td><?php echo $row['return_reason']; ?></td>
											   <td><?php echo $row['opened']; ?></td>
											   <td><?php echo $row['description']; ?></td>
											   <td><?php echo $row['time']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_returnorder.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_returnorder.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_returnorder.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editreturnorder.php?ban=<?php echo $row['id']; ?>">Edit</a>)</td>
