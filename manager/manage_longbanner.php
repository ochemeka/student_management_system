...
redirect_to("manage_longbanner.php?status=asuccess");
}
}
            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Manage Long Banner</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Manage Long Banner</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Manage Long Banner &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="addlongbanner.php">Add Long banner</a></h4>
...
$results = $connection->query("SELECT * FROM bannerlong WHERE status !=7 ORDER BY id ASC LIMIT $page_position, $item_per_page");
...
<img style="width:200px;" src="<?php echo SITE_PATH; ?>uploads/<?php echo $img_url1;  ?>" alt="<?php //echo $row['gal_title']; ?>" height="100" width="100" />
<?php } } ?>
												</td>
                                               <td><?php echo $row['description']; ?></td>
                                                <td>(<?php if($row['status']==1){ ?><a href="manage_longbanner.php?disapprove=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Disapprove</a><?php }else{ ?><a href="manage_longbanner.php?approve=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Approve</a><?php } ?> )&nbsp;(<a href="manage_longbanner.php?delete=<?php echo $row['id']; ?>" onclick="return confirm('Are you sure?');">Delete</a>)&nbsp;(<a href="manage_editlongbanner.php?lban=<?php echo $row['id']; ?>">Edit</a>)</td>
