            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-5 align-self-center">
                        <h4 class="page-title">Edit Ewallet</h4>
                        ...
                        <div class="d-flex no-block justify-content-end align-items-center">
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Edit Ewallet</li>
                                </ol>
                            </nav>
                        </div>
                    </div>
               ...
               <!-- <div class="row">
                ...
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Ewallet</h4>
								
							
                                <!--<form class="m-t-20" method="post" enctype="multipart/form-data">-->
						<form class="m-t-20" method="post" action="manage_editewallet.php?wal=<?php echo $_GET["wal"]; ?>" enctype="multipart/form-data">		
			...
			?>	
								 ...
								 <!-- <input type="hidden" class="form-control"  value="<?php //echo time(); ?>" name="time">-->
                                    ...
                                    <div class="">
										...
										<span>E-Ballance <em style="color:#FF0000;"><?php echo $cat_part['eballance']; ?></em></span>
                                            <input type="text" class="form-control" name="eballance" value="<?php echo $cat_part['eballance']; ?>" placeholder="eballance">
                                        </div>
										
                                       
										
										<div class="form-group">
										<span>User Name <em style="color:#FF0000;"><?php echo $cat_part['username']; ?></em></span>
                                            <input type="text" class="form-control" name="username" value="<?php echo $cat_part['username']; ?>" placeholder="username">
                                        </div>
										
										<div class="form-group">
										<span>User Id <em style="color:#FF0000;"><?php echo $cat_part['user_id']; ?></em></span>
                                            <input type="text" class="form-control" name="user_id" value="<?php echo $cat_part['user_id']; ?>" placeholder="user_id">
                                        </div>
